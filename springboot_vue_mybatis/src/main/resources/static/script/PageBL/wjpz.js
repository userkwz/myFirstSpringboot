...
$(document).ready(function () {
    ...
    $("#tree_caseinfo_doc_files").tree({
        url: '/Handler/BL/GAXXHandler.ashx?action=GetCaseFiles&bmsah=' + bmsah,
        lines: true,
        animate: true,
...
function open_doc_file(node, bmsah, wsbh, type) {
    ...
    $.ajax({
        ...
        data: { action: 'GetDocmentFile', bmsah: bmsah, wsbh: wsbh, sfws: type },
        dataType: "json",
        success: function (result) {
...
function open_doc_file_sealed(node, bmsah, wsbh) {
    ...
    $.ajax({
        type: 'POST',
        url: '/Handler/BL/GAXXHandler.ashx',
        data: { action: 'GetSealedFile', bmsah: bmsah, yyhwsbh: wsbh },
        dataType: "json",
        success: function (result) {
            CloseProgress();
