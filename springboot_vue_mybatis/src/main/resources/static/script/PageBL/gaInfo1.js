...
function ShowAJXX(bmsah, akbm) {
    ...
    $('#gaxx_akxh').val(akbm);
    document.getElementById('iframe2').src = "/View/BL/BL_AJPC/GAXX/AJXX.htm?key=" + url.key + "&bmsah=" + bmsah + "&akname=" + akbm;
    //    $('#gaxx_panel').panel({
...
function ShowGCXX(bmsah, akbm) {
    ...
    document.getElementById('iframe2').src = "/View/BL/BL_AJPC/GAXX/GCXX.htm?key=" + url.key + "&bmsah=" + bmsah + "&akname=" + akbm;
    //    $('#gaxx_panel').panel({
