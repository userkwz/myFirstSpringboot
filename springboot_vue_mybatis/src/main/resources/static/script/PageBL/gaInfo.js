...
$(document).ready(function () {
    ...
    document.getElementById('iframe1').src = "/View/BL/BL_AJPC/GAXX/JZWJ.htm?key=" + url.key + "&bmsah=" + Tyyw_Bmsah;
    Init();
...
function ShowAJXX(akbm) {
    ...
    $('#gaxx_akxh').val(akbm);
    document.getElementById('iframe2').src = "/View/BL/BL_AJPC/GAXX/AJXX.htm?key=" + url.key + "&bmsah=" + Tyyw_Bmsah + "&akname=" + akbm;
    //    $('#gaxx_panel').panel({
...
function ShowGCXX(akbm) {
    ...
    document.getElementById('iframe2').src = "/View/BL/BL_AJPC/GAXX/GCXX.htm?key=" + url.key + "&bmsah=" + Tyyw_Bmsah + "&akname=" + akbm;
    //    $('#gaxx_panel').panel({
