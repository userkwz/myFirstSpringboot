...
$(document).ready(function () {
    ...
    document.getElementById('iframe1').src = "/View/BL/LCJK_AJXX/GAXX/JZWJ.htm?key=" + url.key + "&bmsah=" + Tyyw_Bmsah;
    Init();
...
function ShowAJXX(akbm) {
    ...
    $('#gaxx_akxh').val(akbm);
    document.getElementById('iframe2').src = "/View/BL/LCJK_AJXX/GAXX/AJXX.htm?key=" + url.key + "&bmsah=" + Tyyw_Bmsah + "&akname=" + akbm;
//    $('#gaxx_panel').panel({
...
function ShowGCXX(akbm) {
    ...
    document.getElementById('iframe2').src = "/View/BL/LCJK_AJXX/GAXX/GCXX.htm?key=" + url.key + "&bmsah=" + Tyyw_Bmsah + "&akname=" + akbm;
//    $('#gaxx_panel').panel({
